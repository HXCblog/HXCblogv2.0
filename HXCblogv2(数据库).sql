...
--
-- Host: localhost
-- Generation Time: 2018-10-24 11:22:36
-- 服务器版本： 5.5.60-log
-- PHP Version: 7.0.30
...
(120, 17, '这是一篇测试文章', '这是一篇测试文章', '<p>这是一篇测试文章这是一篇测试文章这是一篇测试文章这是一篇测试文章这是一篇测试文章这是一篇测试文章这是一篇测试文章这是一篇测试文章。</p><p style=\"text-align: center;\"><img src=\"/ueditor/php/upload/image/20181023/1540283611102953.jpg\" title=\"1540283611102953.jpg\" alt=\"default.jpg\"/></p>', 1540283615, 0, 0, 380, 'Huson', '');
...
(6795, 1540350789, '61.151.178.166', '2934'),
(6797, 1540350801, '101.89.29.94', '3489'),
(6796, 1540350798, '61.129.6.151', '2495');
...
INSERT INTO `shuoshuo` (`id`, `time`, `words`) VALUES
(31278, '1540284387', '闲言碎语测试哦');
...
--
-- Indexes for table `newliuyan`
--
ALTER TABLE `newliuyan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `waitlinks`
--
ALTER TABLE `waitlinks`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `picture`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6798;
...
--
ALTER TABLE `shuoshuo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31279;
